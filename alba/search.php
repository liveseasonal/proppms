...
<main>
    ...
    <div class="container text-center">
        <h1 class="font-lg"><?php printf( esc_html__( 'Search Results for: %s', 'alba' ), get_search_query() ); ?></h1>
    </div>
</header>
...
<?php endwhile; else :?> 
            <div class="search-custom" ><h4><?php
                            ...
                            echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'alba' ) ;?></h4>
